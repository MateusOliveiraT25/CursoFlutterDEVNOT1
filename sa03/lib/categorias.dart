...
extension CategoriaExtension on Categoria {
  ...
  String get nome {
   ...
   // Serializa a Categoria para uma String
  String toJson() {
    return this.toString().split('.').last;
  }

  // Deserializa a String para uma Categoria
  static Categoria fromJson(String json) {
    return Categoria.values.firstWhere((categoria) => categoria.toJson() == json, orElse: () => Categoria.Outros);
  }
}
